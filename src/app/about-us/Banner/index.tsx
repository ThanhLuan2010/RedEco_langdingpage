      ...
      <div className="absolute top-0 h-[100%] flex flex-col justify-center px-[20px] md:px-[5%] xl:px-[10%] text-white overflow-hidden mx-[20px] md:mx:0 md:translate-y-[-5%] w-[80%]">
        ...
        <div className="flex gap-[20px] md:gap-[25px] xl:gap-[30px] mt-[13px] w-[65%] md:w-[60%] lg:w-[60%] z-20">
          <button
            ...
            className="bg-gradient-to-br from-[#28FF90] -7.86% to-[#00954F] 67.26% py-[10px] lg:py-[10px] xl:py-[20px] rounded-[8px] 
          ...
          <button
            ...
            className="py-[10px] xl:py-[20px] rounded-[8px] w-[50%] border-[1px] border-[#F0F0F0] font-semibold text-[9px] md:text-[12px] ld:text-[15px] xl:text-[16px] 2xl:text-[18px]"
          >
            CONTACT US
          </button>
        </div>
