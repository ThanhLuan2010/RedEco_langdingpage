...
export default function Banner() {
  ...
  .slick-dots li.slick-active button {
    background: linear-gradient(90deg, #28FF90, #00954F); /* Màu gradient cho dot active */
    ...
    <Box sx={{ width: '100vw', position: "relative", height: "90vh", }}>
      <StyledCarousel autoplay autoplaySpeed={2000}>
        <Box width={"100vw"} height={"100%"}>
          <Image style={{ width: "100%", height: "100%" }} alt='banner' src={require("../../../public/image/banner1.png")} />
        </Box>
        <Box width={"100vw"} height={"100%"}>
          <Image style={{ width: "100%", height: "100%" }} alt='banner' src={require("../../../public/image/banner2.png")} />
        </Box>
        <Box width={"100vw"} height={"100%"}>
          <Image style={{ width: "100%", height: "100%" }} alt='banner' src={require("../../../public/image/banner3.png")} />
        </Box>
        <Box width={"100vw"} height={"100%"}>
          <Image style={{ width: "100%", height: "100%" }} alt='banner' src={require("../../../public/image/banner4.png")} />
        </Box>
      </StyledCarousel>
      <Box
        sx={{
