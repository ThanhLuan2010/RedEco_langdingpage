...
export default function Banner() {
  ...
  return (
    <Box sx={{ width: "100vw", position: "relative", height: "100%" }}>
      ...
      >
        <text className="font-bold text-[20px] xl:text-[50px] leading-[30px] lg:leading-[73.14px]">
          We <span style={{ color: "#39E63D" }}>Provide</span> The Best
        </text>
        <text className="font-bold text-[20px] xl:text-[50px] leading-[30px] lg:leading-[73.14px] flex">
          industrial solution
        ...
        <div className="flex gap-[20px] xl:gap-[35px] mt-[35px] w-[65%]">
          <button className="bg-gradient-to-r from-[#28FF90] -7.86% to-[#00954F] 67.26% py-[10px] rounded-[8px] text-[9px] w-[50%] font-bold">
            OUR SERVICES
          </button>

          <button className="py-[10px] rounded-[8px] text-[9px] w-[50%] border-[1px] border-[#F0F0F0] font-bold">
            CONTACT US
          </button>
        </div>
      </Box>
