...
const ProductionLine = () => {
  return (
    <div className="px-20px md:px-[5%] xl:px-[10%]">
      <div className="justify-center flex flex-col mt-[40px] md:mt-[60px] lg:mt-[72px] xl:mt-[90px] 2xl:mt-[100px] px-[20px] ">
        ...
        <div className="flex justify-center">
          <text className="text-center mt-[18px] md:mt[25px] xl:mt-[30px] 2xl:mt-[32px] w-[100%] md:w-[80%] text-[14px] xl:text-[20px] leading-[20px] md:leading-[23px] lg:leading-[28px] xl:leading-[30px] text-[black]">
        ...
        <div className="flex flex-col md:flex-row overflow-hidden h-[80vh] gap-[18px] md:gap-[22px] lg:gap-[26px] xl:gap-[32px] 2xl:gap-[35px] mt-[32px] md:mt-[40px] xl:mt-[45px]">
          ...
          <div className="h-[50%] md:h-[100%] flex flex-col w-[100%] md:w-[50%] gap-[18px] md:gap-[22px] lg:gap-[26px] xl:gap-[32px] 2xl:gap-[35px]">
