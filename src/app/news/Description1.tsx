...
function Description1() {
  return (
    <div className="flex flex-col">
      ...
      <text className="mt-[18px] md:mt-[24px] lg:mt-[28px] xl:mt-[2rem] text-[#000000] font-medium md:font-semibold text-[16px] md:text-[17px] xl:text-[18px]">
      ...
      <div className="flex flex-col sm:flex-col md:flex-row mt-[20px] md:mt-[30px] xl:mt-[40px]">
        <div className="sm:w-[100%] md:w-[60%] flex flex-col">
          ...
          <text className="mt-[5px] text-[15px] md:text-[16px] xl:text-[18px]">
          ...
          <text className="mt-[0px] text-[15px] md:text-[16px] xl:text-[18px] text-[#252724] font-normal leading-[30px]">
      ...
      <div className="flex mt-[24px] md:mt-[30px] xl:mt-[40px] 2xl:mt-[42px] flex-col-reverse md:flex-row sm:flex-col-reverse ">
      ...
      <div className="flex flex-col sm:flex-col md:flex-row mt-[24px] md:mt-[30px] xl:mt-[40px] 2xl:mt-[42px]">
        <div className="w-[100%] md:w-[60%] flex flex-col justify-center">
          <text className="text-[20px] md:text-[22px] lg:text-[24px] xl:text-[26px] 2xl:text-[28px] font-bold text-[#00366A]">
            On-Time Delivery
          </text>
