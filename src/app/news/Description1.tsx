...
function Description1() {
  return (
    <div className="flex flex-col">
      ...
      <text className="mt-[18px] md:mt-[24px] lg:mt-[28px] 2xl:mt-[2rem] text-[#000000] font-medium text-[16px] md:text-[17px] 2xl:text-[18px]">
      ...
      <div className="flex flex-col sm:flex-col md:flex-row mt-[20px] md:mt-[30px] 2xl:mt-[40px]">
        <div className="sm:w-[100%] md:w-[60%] flex flex-col">
          ...
          <text className="mt-[10px] text-[15px] md:text-[16px] 2xl:text-[18px]">
          ...
          <text className="mt-[6px] text-[15px] md:text-[16px] 2xl:text-[18px] text-[#252724] font-normal leading-[30px]">
      ...
      <div className="flex mt-10 flex-col-reverse md:flex-row sm:flex-col-reverse">
        ...
        <div className="w-[100%] md:w-[60%] flex flex-col justify-center">
          ...
          <text className="mt-[5px] text-[15px] md:text-[16px] 2xl:text-[18px] text-[#252724] font-normal leading-[30px]">
