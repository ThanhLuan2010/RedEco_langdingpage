    ...
    <div className="w-[100%] flex flex-col text-white font-medium text-center">
      <div className="flex flex-col items-center justify-center">
        <div className="flex items-start">
          <text className="text-[50px] md:text-[65px] lg:text-[60px] xl:text-[80px] 2xl:text-[90px] xl:leading-[120%] font-semibold relative">
            {formattedNumber}
        ...
        <text className="text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]  font-semibold ">
          {title}
        </text>
      </div>
    </div>
